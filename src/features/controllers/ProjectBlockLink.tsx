...
export const ProjectBlockLink = ({
  ...
  <NavLinkButton
    className="theme__nav-link group !p-[20px] col-start-1 col-end-3 text-left border border-solid border-blackRgba10 rounded-md z-0"
    linkTo={`${NAVIGATION_PATHS.PROJECTS}/${projectId}`}
  >
    <div className="w-full flex items-center gap-4">
      <Avatar
        className="w-[48px] h-[48px] min-w-[48px] min-h-[48px] relative before:w-[60px] before:h-[60px] before:block before:absolute before:-right-[6px] before:top-1/2 before:-translate-y-1/2 before:rounded-full before:bg-blackRgba7 before:border before:border-solid before:border-blackRgba10 before:z-[-10] dark:before:border-darkGray dark:before:bg-darkGray"
